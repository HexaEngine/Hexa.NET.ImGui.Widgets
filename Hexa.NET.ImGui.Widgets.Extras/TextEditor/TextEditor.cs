namespace Hexa.NET.ImGui.Widgets.Extras.TextEditor
{
    ...
    public unsafe class TextEditor
    {
        ...
        public TextEditor(string tabName, TextSource source)
        {
            name = new(tabName);
            this.source = source;
        ...
        public TextEditor(TextSource source, string currentFile)
        {
        ...
        public void Draw(byte* pName, Vector2 size)
        {
